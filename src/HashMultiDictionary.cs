...
// A multi-dictionary implemented using hash tables for fast but unordered access and modification.
// public class HashMultiDictionary<TKey, TValue> : IMultiDictionary<TKey, TValue>
// {
